      ...
      {calls.map((_, i) => (
        <li key={i}>
          <article className='grid grid-cols-[auto_1fr] items-center gap-x-2'>
            <ArrowBackIcon className='row-start-1 row-end-3 h-5 w-5 rotate-90 rounded-2xl bg-green-400 fill-white p-0.5' />
            <header className='flex justify-between font-medium'>
              <span>Incoming</span> <span className='text-black/90'>08:29 mins</span>
            </header>
            <footer className='flex justify-between font-medium text-black/50'>
              <small>16:25</small>
              <small>12.8 MB</small>
            </footer>
          </article>
