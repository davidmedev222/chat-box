    ...
    <article className='grid grid-cols-[auto_1fr_auto] items-center gap-x-4 px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600'>
      ...
      <div className='grid'>
        ...
        <div className='grid grid-cols-[auto_1fr] items-center gap-x-1'>
          <ArrowBackIcon className='h-3.5 w-3.5 rotate-90 rounded-2xl bg-green-400 fill-white p-0.5 dark:fill-black' />
          <p className='line-clamp-1 text-gray-500 dark:text-gray-300'>Incoming | Yesterday 16:25</p>
        </div>
      </div>
      <button>
