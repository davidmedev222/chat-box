...
function AdvancedQueryIcon({ className }: Props) {
  return (
    <svg className={className} xmlns='http://www.w3.org/2000/svg' height='40' viewBox='0 -960 960 960' width='40'>
...
export default AdvancedQueryIcon
